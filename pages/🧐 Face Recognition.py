...
svc = joblib.load(
    'D:/SV3_2/Digital_image_processing/Final_Project/20133102_NguyenNhatTrieu/App_Streamlit/pages/svc.pkl')
mydict = ['NhatTrieu', 'ThayDuc']
...
if __name__ == '__main__':
    detector = cv.FaceDetectorYN.create(
        'D:/SV3_2/Digital_image_processing/Final_Project/20133102_NguyenNhatTrieu/App_Streamlit/pages/face_detection_yunet_2022mar.onnx',
        "",
        (320, 320),
        0.9,
        0.3,
    ...
    recognizer = cv.FaceRecognizerSF.create(
        'D:/SV3_2/Digital_image_processing/Final_Project/20133102_NguyenNhatTrieu/App_Streamlit/pages/face_recognition_sface_2021dec.onnx', "")
